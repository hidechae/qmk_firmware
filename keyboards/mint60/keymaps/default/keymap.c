...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    MO(1),     KC_GRV,    KC_LALT,    KC_LGUI,    KC_SPC,        KC_ENT, KC_RGUI,                  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT \
  ),
  [1] = LAYOUT( \
    ...
    XXXXXXX,   _______,    _______,    _______,    XXXXXXX,       XXXXXXX, XXXXXXX,                    KC_HOME, KC_PGUP, KC_PGDN, KC_END \
  )
/**
  [0] = LAYOUT( \
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,    KC_BSPC,  \
