...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | Ctrl |                    | Shift|   N  |   M  |   ,  |   .  |   /  | Shift|
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Lower| Ctrl |  EISU| Alt  |||||||| GUI  | Space|      ||||||||      | Enter| GUI  |||||||| Alt  | EISU | Ctrl | Raise|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LCTL,                        KC_RSFT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, \
    LOWER,   KC_LCTL, EISU,    KC_LALT,          KC_LGUI, KC_SPC ,KC_SPC,          KC_SPC,KC_ENT , KC_RGUI,          KC_RALT, EISU,    KC_RCTL, RAISE  \
  ),
